...
def load_dataset_for_previous_run(run_id, **kwargs): # => dataset_obj, mirror_augment
    ...
    # print('------dataset---------%s----%s'%(config.data_dir,dataset_cfg))
    #dataset_cfg['tfrecord_dir'] = 'cifar10'
    # print('after------dataset---------%s----%s'%(config.data_dir,dataset_cfg))
    dataset_obj = dataset.load_dataset(data_dir=config.data_dir, **dataset_cfg)
    # print('--------295------%s',mirror_augment)
