...
def train_progressive_gan(
    ...
    network_snapshot_ticks  = 5,#5,           # How often to export network snapshots?
    save_tf_graph           = False,        # Include full TensorFlow computation graph in the tfevents file?
    save_weight_histograms  = False,        # Include weight histograms in the tfevents file?
    resume_run_id           = None,#None,         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,#12000,#None,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 0.0,#0.0,          # Assumed training progress at the beginning. Affects reporting and training schedule.
